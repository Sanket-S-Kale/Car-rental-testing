...
public class CarRental_RentalManager_CheckCarAvailability extends Car_Rental_Test {
  ...
  public void testMyFirstWebDriver() throws Exception {
	...
	driver.findElement(By.xpath(prop.getProperty("Btn_ManagerCheckCarAvailability"))).click();
